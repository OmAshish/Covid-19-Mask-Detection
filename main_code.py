...
training_set = train_datagen.flow_from_directory('C:\\Users\\OM MISHRA\\(OM)\\dataset\\training_data',
                                                 target_size = (160, 160),
                                                 batch_size = 32,
                                                 class_mode = 'binary')

test_set = test_datagen.flow_from_directory('C:\\Users\\OM MISHRA\\(OM)\\dataset\\test_data',
                                            target_size = (160, 160),
                                            batch_size = 32,
                                            class_mode = 'binary')
...
classifier.save('D:/Projects/Mask and Un-mask Project/mtcnn_face_mask.h5')